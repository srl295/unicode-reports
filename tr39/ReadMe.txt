...
This public directory contains data files for the UTS #36: Unicode Security Mechanisms.

The subdirectories contain data files associated with a given version, with names such as:
